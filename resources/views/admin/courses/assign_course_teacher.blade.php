...
@section('title') Admin - Teacher Assigned Courses @stop
@section('content')
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <div class="tddts">
                        <h4 class="text-center">ALL ASSIGNED COURSES TO TEACHERS</h4>
                            <button type="button" class="btn btn-primary" id="modal_container_btn">ASSIGNED COURSE TO TEACHER</button>
                        </div>
                    </div>
                    <div class="box-body">
                        <table id="datatable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @forelse($assigned_courses as $key=>$record)
                                <tr>
                                    <td>{{++$key}}</td>
                                    ...
                                    <td>
                                        <select name="" id="" class="form-control">
                                          @forelse($record->course as $course)
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title"><b>ASSIGNED COURSE TO TEACHER</b></h4>
            </div>
     ...
     $(document).ready(function() {
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    "_token": "{{ csrf_token() }}",course_id:course_id,user_id:user_id
                },
