        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li>
                        <a href="{{route('assign-course-to-teacher')}}">
                            <i class="fa fa-dashboard"></i> <span>Assign Course to Teacher</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{route('assign-course-to-student')}}">
                            <i class="fa fa-dashboard"></i> <span>Assign Course to Student</span>
                        </a>
                    </li>
                </ul>
            </section>
