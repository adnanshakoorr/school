    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="" class="logo">
                ...
                <span class="logo-mini">Student Panel</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg">Student Panel</span>
            </a>
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    <li>
                        <a href="{{route('course-teacher')}}">
                            <i class="fa fa-dashboard"></i> <span>Course Teacher</span>
                        </a>
                    </li>
                </ul>
                </ul>
